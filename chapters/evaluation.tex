...
Young tool. new tool. many possibilities. not enough time to test them
all.
...
% about how precise these averages are. In Figure~\ref{fig:betw_distr} we
% see such plots for the betweenness centralities in PolderCast and Scribe
% at interval 1000, running both the Facebook and Twitter datasets.
