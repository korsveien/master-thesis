...
able to visually confirm that the overlay in scribe was fully connected
by inspecting the graph in Gephi. This confirm in practice the
brittleness of the overlay structures of Scribe, but this needs further
investigation. This investigation should include adjusting the churn
rate in order to see the effects of the overlays, and perhaps compare
the density of the graph, looking at the number of edges formed as well
as evaluating its connectivity.
