...
\begin{figure}
    ...
    \subfigure[PolderCast]{%
        \includegraphics[scale=0.64]{figures/polder_structure}
        \label{fig:scribe_struct}
    }
    \subfigure[Scribe]{%
        \includegraphics[scale=0.64]{figures/scribe_structure}
        \label{fig:polder_struct}
    }
    \caption{Visualizaton of the \textbf{overlay strucure}
        of PolderCast and Scribe after 1000 intervals}
    \label{fig:struct}
\end{figure}
...
\begin{figure}
    ...
    \thisfloatpagestyle{empty}
    \subfigure[PolderCast]{%
        \includegraphics[scale=0.64]{figures/polder_degree}
        \label{fig:polder_degree}
    }
    \subfigure[Scribe]{%
        \includegraphics[scale=0.64]{figures/scribe_degree}
...
Looking at the overlay structures in Figure~\ref{fig:polder_struct} and
...
Figure~\ref{fig:polder_indegree_distr},~\ref{fig:polder_outdegree_distr},~\ref{fig:scribe_indegree_distr}
