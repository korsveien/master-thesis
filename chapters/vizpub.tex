...
in~\cite{}. The resulting \gexf{} files are imported into Gephi
...
calculated values are described in Table~\ref{tab:struct_metrics}. These
values are averages across the duration of the experiment.
