...
are imported into Gephi in order to analyse the overlay structure both
visually as well by calculating certain metrics using the
\emph{Statistics Component}, which we lay out in
...
\begin{table}
    ...
    \begin{tabular}{|l | l | l |}
        ...
        \hline
        No.\ of Nodes & 771 & 771 \\ \hline
        No.\ of Edges & 24152 & 2700 \\ \hline
        Avg. Degree & 31.33 & 3.50 \\ \hline
        Graph Diameter & 5 & 15 \\ \hline
        Avg. Path Length & 2.43 & 5.26 \\ \hline
        Graph Density & 0.041 & 0.005 \\ \hline
        Weakly Connected Components & 7 & 84 \\ \hline
        Strongly Connected Components & 20 & 307 \\ \hline
        Avg. Clustering Coefficient & 0.249 & 0.035 \\ \hline
...
\begin{figure*}[h!]
    \centering
    \includegraphics[scale=0.4]{figures/struct_poldercast}
    \caption{Overlay structure of PolderCast after 1000 reporter
        intervals and 1000 PeerNet cycles.}
    \includegraphics[scale=0.4]{figures/struct_scribe}
