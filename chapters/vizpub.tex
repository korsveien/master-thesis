...
\begin{figure}
    ...
    \subfigure[PolderCast]{%
        \includegraphics[scale=0.65]{figures/polder_structure}
        \label{fig:scribe_struct}
    }
    \subfigure[Scribe]{%
        \includegraphics[scale=0.65]{figures/scribe_structure}
...
\begin{figure}
    ...
    \thisfloatpagestyle{empty}
    \subfigure[PolderCast]{%
        \includegraphics[scale=0.65]{figures/polder_degree}
        \label{fig:polder_degree}
    }
    \subfigure[Scribe]{%
        \includegraphics[scale=0.65]{figures/scribe_degree}
