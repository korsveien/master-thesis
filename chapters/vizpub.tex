...
\begin{figure*}[h!]
    \centering
    \includegraphics[scale=0.38]{figures/polder_degree}
    \caption{Visualization of \textbf{degree} in PolderCast after 1000 reporter
        intervals and 1000 PeerNet cycles.}
    \label{fig:polder_in_degree}
    \includegraphics[scale=0.38]{figures/scribe_degree}
    \caption{Visualization of \textbf{degree} of Scribe after 1000 reporter
        intervals and 1000 PeerNet cycles.}
    \label{fig:polder_in_degree}
\end{figure*}
