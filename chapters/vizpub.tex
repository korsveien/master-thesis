...
visually on various performance metrics.

\subsection{Overlay Evolution During Churn}

In Figure~\ref{fig:churn0},~\ref{fig:churn250} and~\ref{fig:churn500} we
visualize the overlay topology of PolderCast during churn, using the
real-world churn traces from the Skype super-peer network
from~\cite{Guha:2006}.
